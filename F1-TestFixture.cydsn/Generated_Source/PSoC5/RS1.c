...
*
* \funcusage
*  \snippet RS1_SUT.c usage_RS1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet RS1_SUT.c usage_RS1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet RS1_SUT.c usage_RS1_Read  
*******************************************************************************/
uint8 RS1_Read(void)
{
...
* preferred RS1_Read() API because the 
* RS1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet RS1_SUT.c usage_RS1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: RS1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use RS1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - RS1_0_INTR       (First pin in the list)
    *  - RS1_1_INTR       (Second pin in the list)
    *  - ...
    *  - RS1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet RS1_SUT.c usage_RS1_SetInterruptMode
    *******************************************************************************/
    void RS1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & RS1_0_INTR) != 0u) 
		{ 
			 RS1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet RS1_SUT.c usage_RS1_ClearInterrupt
    *******************************************************************************/
