...
*
* \funcusage
*  \snippet GPS_RX_SUT.c usage_GPS_RX_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet GPS_RX_SUT.c usage_GPS_RX_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet GPS_RX_SUT.c usage_GPS_RX_Read  
*******************************************************************************/
...
* preferred GPS_RX_Read() API because the 
* GPS_RX_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet GPS_RX_SUT.c usage_GPS_RX_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: GPS_RX_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use GPS_RX_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - GPS_RX_0_INTR       (First pin in the list)
    *  - GPS_RX_1_INTR       (Second pin in the list)
    *  - ...
    *  - GPS_RX_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet GPS_RX_SUT.c usage_GPS_RX_SetInterruptMode
    *******************************************************************************/
    void GPS_RX_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & GPS_RX_0_INTR) != 0u) 
		{ 
			 GPS_RX_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet GPS_RX_SUT.c usage_GPS_RX_ClearInterrupt
    *******************************************************************************/
